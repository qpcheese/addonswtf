...
["code"] = "ability(Poison Protocol:1954)\nability(Wind-Up:459) [ enemy(#2).active ]\nability(Curse of Doom:218) [ self.round=1 ]\nability(Amplify Magic:488) [ enemy.aura(Curse of Doom:217).duration=2 ]\nability(#1)\nchange(next)",
},
["team:244"] = {
["name"] = "Are They Not Beautiful? (Humanoid)",
["code"] = "change(#2) [round=4]\nquit [self(#3).active & enemy(#2).active]\nuse(Soulrush:752) [enemy(Beeks:3566).active]\nuse(Creeping Insanity:1760) [!enemy(Beeks:3566).active]\nuse(Spiritfire Bolt:1066)\nuse(Ice Lance:413) [enemy(Fethres:3565).active]\nuse(Gift of Winter's Veil:586)\nuse(Call Blizzard:206)\nuse(Ice Lance:413)\nchange(Void-Scarred Anubisath:2833) [self.dead]\nuse(Weakness:471) [enemy.aura(Creeping Insanity:1759).exists]\nuse(Nether Blast:608)",
...
["code"] = "use(Lift-Off:170) [ enemy.aura(Underground:340).exists ]\nuse(Lift-Off:170) [ enemy(#2).active ]\nuse(Adrenaline Rush:162) [ enemy(#1).active & enemy.hp<173 & self.power>324 ]\nuse(Adrenaline Rush:162) [ enemy(#1).active & enemy.hp<163 & self.power>304 ]\nuse(Adrenaline Rush:162) [ enemy(#1).active & enemy.hp<159 & self.power>296 ]\nuse(Adrenaline Rush:162) [ enemy(#1).active & enemy.hp<155 & self.power>288 ]\nuse(Adrenaline Rush:162) [ enemy(#1).active & enemy.hp<149 & self.power>275 ]\nuse(Adrenaline Rush:162) [ enemy(#1).active & enemy.hp<141 & self.power>259 ]\nuse(Adrenaline Rush:162) [ self.speed.slow ]\nuse(Call Lightning:204) [ enemy(#1).dead ]\nuse(Flock:581) [ weather(Lightning Storm) ]\nuse(Soulrush:752) [ enemy(#3).hp<770 ]\nuse(Soulrush:752) [ enemy(#3).hp<1154 & enemy.aura(Shattered Defenses:542).exists ]\nuse(Moonfire:595) [ enemy(#3).active ]\nuse(Soulrush:752)\nuse(#1)\nchange(next)",
},
["team:51"] = {
["name"] = "Ashes Will Fall",
["code"] = "use(Взрыв:282) [round=5]\nuse(Ледяной выстрел:1865)",
...
["code"] = "change(#2) [ self.ability(Consume Magic:1231).usable & !enemy.ability(Cyclone:190).usable & self.hp<498 & self(#2).hp<326 ]\nquit [ round=2 & enemy.hpp=100 ]\nstandby [ self(#2).active & enemy(#2).active & enemy.hp<393 ]\nuse(Interrupting Gaze:474) [ self(#2).active & enemy(#2).active & self.round=4 ]\nchange(#3) [ enemy(#3).active ]\nuse(Soul Ward:751) [ enemy(#1).active & enemy.ability(Moth Dust:508).duration<2 & self.speed.slow & round>1 ]\nuse(Soul Ward:751) [ enemy(#1).active & enemy.ability(Moth Dust:508).usable & self.speed.fast ]\nuse(Soul Ward:751) [ enemy(#1).hp<186 ]\nuse(Light:461) [ enemy.hp<371 ]\nuse(Flash:463)\nuse(Light:461) [ enemy.aura(Partially Blinded:462).exists ]\nuse(Eyeblast:475) [ enemy(#2).active & self.round>1 ]\nuse(#1) [ enemy(#3).active & enemy.ability(Cyclone:190).usable & enemy.hp<655 & self.hp>237 ]\nuse(Consume Magic:1231) [ self.aura(Cyclone:189).exists ]\nuse(Consume Magic:1231) [ enemy(#3).active & enemy.ability(Cyclone:190).usable ]\nuse(Illusionary Barrier:465) [ enemy(#3).active ]\nuse(#1) [ self(#3).active & self.ability(Illusionary Barrier:465).duration<5 ]\nuse(#1) [ !self(#3).active ]\nstandby\nchange(next)",
},
["team:77"] = {
["name"] = "Dr. Ion Goldbloom",
...
["code"] = "quit [ self(#1).dead & enemy(#2).active & enemy.round<4 ]\nquit [ self(#1).dead & self(#2).dead & self.hpp<100 & enemy(#2).active ]\nif [ enemy(#3).active ]\n    use(Prowl:536)\n    use(Call Darkness:256)\nendif\nuse(Screech:357) [ !enemy.aura(Speed Reduction:154).exists ]\nuse(Pounce:535)\nuse(Stampede:163)\nuse(Dust Cloud:2059) [ enemy(#2).active ]\nuse(Dust Cloud:2059) [ enemy.aura(Underground:340).exists ]\nuse(Rush:567) [ self.aura(Dodge:2060).exists ]\nuse(Rampage:124) [ enemy(#2).active & enemy.round>1 ]\nuse(Rush:567)\nstandby\nchange(next)\n--",
},
["team:214"] = {
["name"] = "Storm-Touched Slyvern",
["code"] = "use(Arcane Storm:589) [round=1]\nuse(Mana Surge:489)\nchange(Arcane Eye:1160)\nuse(Eyeblast:475)\nuse(#1)\nchange(next)",
...
["code"] = "ability(#1) [ enemy(Runehoof:3001).dead & enemy(Duster:3002).dead ]\nability(Sunlight:404)\nability(Nature's Ward:574) [ !self.aura(Nature's Ward:820).exists ]\nability(Wish:273)\nability(Renewing Mists:511) [ !self.aura(Renewing Mists:510).exists ]\nchange(Puddle Terror:1568)\nchange(Magical Crawdad:132)",
},
["team:114"] = {
["name"] = "Tiny Madness",
["code"] = "ability(Shadow Slash:210) [round = 1]\nstandby [round = 2]\nability(Curse of Doom:218)\nability(Haunt:652)\nchange(Infected Squirrel:627)\nability(Rabid Strike:666) [!enemy.aura(Rabies:807).exists] \nability(Stampede:163)\nchange(Graves:1639)\nability(Grave Destruction:1411)\nability(Skull Toss:1483)",
...
["team:80"] = {
["name"] = "Fight Night: Tiffany Nelson",
["code"] = "quit [ enemy(#1).dead & round = 2 ]\nchange(#2) [self(#3).active]\nchange(#2) [round=3]\nchange(#3) [enemy(#3).active & enemy.round=1]\nchange(#1) [enemy(#3).active & self.aura(Amplify Magic:487).exists]\n\nability(Booby-Trapped Presents:1080) [round=2]\nability(Amplify Magic:488) [round~5,10]\nability(Greench's Gift:1076)\nability(#1)",
},
["team:154"] = {
["name"] = "Automated Chaos",
["code"] = "standby [enemy(\"Fixed\" Remote Control Rocket Chicken:2204).active]\nability(Call Blizzard:206)\nability(Deep Freeze:481) [enemy.hp>=444]\nability(#1)\nchange(next)",
...
["code"] = "ability(Creeping Insanity:1760)\nability(Corpse Explosion:663) [ round=3 ]\nability(Flash Freeze:1955)\nability(Deep Freeze:481)\nability(Emerald Presence:597) [ self.aura(Emerald Presence:823).duration<2 ]\nability(Emerald Dream:598) [ self.hpp<66 ]\nability(Emerald Presence:597) [ enemy.aura(Dodge:311).exists ]\nability(Emerald Presence:597) [ enemy.aura(Flying:341).exists & self.speed.fast ]\nability(Emerald Presence:597) [ enemy.aura(Underground:340).exists & self.speed.fast ]\nability(Emerald Presence:597) [ enemy.aura(Silk Cocoon:505).exists ]\nability(Emerald Presence:597) [ enemy.aura(Underwater:830).exists & self.speed.fast ]\nability(#1)\nchange(next)",
},
["team:17"] = {
["name"] = "Chittermaw",
["code"] = "ability(Murder the Innocent:2223)\nability(Explode:282)\nchange(next)",
...
["code"] = "ability(Amplify Magic:488)\nability(Arcane Storm:589)\nability(Slime:1763) [ enemy(#3).active ]\nability(Toxic Smoke:640)\nability(Soul Ward:751) [ enemy.ability(Moonfire:595).usable ]\nability(Soulrush:752)\nability(#1)\nchange(next)",
},
["team:291"] = {
["name"] = "Ashlei",
...
["team:125"] = {
["name"] = "Fight Night: Amalia",
["code"] = "quit [!self(#3).exists]\nquit [self(#1).dead & !enemy(#2).dead]\nquit [self(#2).dead]\n\nif [self(#1).active]\n  change(#2) [enemy(#2).active & !self(#2).played & self.speed.fast]\n  change(#3) [enemy(#3).active]\n  use(Powerball:566) [self.speed.slow]\n  use(Supercharge:208) [self.aura(Wind-Up:458).exists]\n  use(Wind-Up:459)\nendif\n\nif [self(#3).active]\n  use(Prowl:536)\n  use(Dive:564)  \nendif\n\nchange(#1) [self(#2).active]",
},
["team:202"] = {
["name"] = "Risen Guard",
["code"] = "standby [enemy(#2).type=4 & enemy(#1).aura(Undead:242).exists]\nstandby [enemy(#3).type=4 & enemy(#2).aura(Undead:242).exists]\nstandby [enemy(#2).type=2 & enemy(#1).aura(Undead:242).exists]\nstandby [enemy(#3).type=2 & enemy(#2).aura(Undead:242).exists]\nchange(#2) [enemy(#1).aura(Undead:242).exists & enemy(#2).type=6]\nchange(#2) [enemy(#2).aura(Undead:242).exists & enemy(#3).type=6]\n-----------------------\nability(Blinding Poison:1049) [round=1]\nability(Decoy:334) [enemy.round=2]\nability(Thunderbolt:779)\nchange(#1) [self(#2).active & enemy.type=4]\nability(Poison Fang:152) [enemy.is(Plague Whelp:2606) & enemy.round=1]\nability(Blinding Poison:1049) [!enemy(#1).active & !enemy.aura(Undead:242).exists]\nability(Poison Fang:152) [!enemy(#1).active & !enemy.aura(Poisoned:379).exists & enemy.type=6]\nchange(#1) [self(#2).active & enemy.type=4]\nability(#1)\nchange(next)",
...
["code"] = "quit [ self(#1).dead & !enemy(#1).dead ]\nstandby [ enemy(#3).active & enemy.round=2 & !self.ability(Prowl:536).usable ]\nstandby [ round=2 ]\nuse(Rabid Strike:666) [ enemy.round=3 ]\nuse(Bash:348) [ enemy(#2).active ]\nuse(Vengeance:997) [ self.aura(Beast:237).exists ]\nuse(Survival:283) [ self.round=2 ]\nuse(Prowl:536) [ enemy(#3).active & enemy.round>1 ]\nuse(Moonfire:595) [ self.aura(Prowl:543).exists ]\nuse(#1)\nchange(next)",
},
["team:126"] = {
["name"] = "Crypt Fiend",
["code"] = "use(Lightning Shield:906) \nuse(Fire Shield:1754) \nuse(Arcane Blast:421) \nuse(Decoy:334) \nuse(Thunderbolt:779) \nuse(Breath:115) \nuse(#1) \nchange(next)",
...
["code"] = "use(Roar:347) [ enemy(#1).active & enemy.hp<181 ]\nuse(Smash:349) [ enemy(#1).active & enemy.hpp<30 ]\nuse(Smash:349) [ self.aura(Undead:242).exists & !self.aura(Barrel Ready:353).exists ]\nuse(Barrel Toss:354) [ round>1 ]\nuse(Toxic Smoke:640) [ enemy(#2).active & enemy.hp<375 ]\nuse(Slime:1763) [ enemy.aura(Toxic Smoke:639).exists ]\nuse(Toxic Smoke:640)\nif [ enemy(#3).active ]\n    use(Prowl:536)\n    use(Call Darkness:256)\n    use(Spectral Strike:442)\nendif\nuse(#1)\nstandby\nchange(next)",
},
["team:35"] = {
["name"] = "Cymre Brightblade",
...
["code"] = "change(next) [self.dead]\n\nif [self(Iron Starlette:1387).active]\nability(Explode:282) [round>2] \nability(Wind-Up:459) \nendif\n\nif [self(Draenei Micro Defender:1450).active]\nability(Explode:282) [enemy(Giant Opaline Conch:2734).hp.can_explode]\nability(Reflective Shield:1105)\nability(Metal Fist:384)\nendif",
},
["team:272"] = {
["name"] = "Brok",
...
["code"] = "use(Amplify Magic:488) [ enemy(#3).active ]\nuse(Dust Cloud:2059) [ enemy.aura(Prowl:543).exists ]\nuse(Dust Cloud:2059) [ enemy.aura(Beast:237).exists ]\nuse(Void Nova:2356) [ !enemy(#3).active ]\nuse(Arcane Storm:589)\nuse(Moonfire:595)\nuse(Soulrush:752)\nuse(#1)\nstandby\nchange(next)",
},
["team:163"] = {
["name"] = "Natural Defenders (Humanoid)",
["code"] = "change(next) [ round=2 ]\nchange(#1) [ self(#2).dead & enemy(#2).active ]\nability(Booby-Trapped Presents:1080) [ enemy(#1).active ]\nability(Greench's Gift:1076)\nability(Gift of Winter's Veil:586)\nability(Deflection:490) [ enemy.aura(Underground:340).exists ]\nability(Deflection:490) [ enemy(#2).active ]\nability(Rampage:124)\nability(Call Blizzard:206)\nability(#1)\nchange(next)",
},
["team:79"] = {
["name"] = "Resilient Survivors",
["code"] = "ability(Prowl:536) [self.aura(Blinding Poison:1048).exists]\nstandby [self.aura(Blinding Poison:1048).exists]\nability(Whirlpool:513) [enemy.round=1]\nability(Dive:564) [round=2]\nability(Arcane Storm:589)\nability(Mana Surge:489)\nability(#1)\nchange(next)",
...
["code"] = "use(Apocalypse:519) [ round~1,26 ]\nuse(Refuge:1344) [ !enemy(#3).active ]\nstandby [ round~19,22,30,37 ]\nstandby [ self(#1).active & self.aura(Block:759).exists ]\nchange(#3) [ round~6,15,21,29,36 ]\nuse(Illusionary Barrier:465) [ round~8,14,20,23,28,31,35,38 ]\nchange(#1) [ round~9,16,24,32,39 ]\nuse(Spiritfire Bolt:1066) [ round>41 ]\nuse(Moon Tears:979)\nuse(Scratch:119) [ round>41 ]\nchange(next)",
},
["team:288"] = {
["name"] = "Jeremy Feasel",
...
["code"] = "ability(Alert!:1585) [ round=1 ]\nability(Supercharge:208)\nability(Ion Cannon:209)\nability(Toxic Smoke:640) [ self.round=1 ]\nability(Zap:116) [ self.round=2 ]\nability(Explode:282)\nability(Call Lightning:204) [ enemy(#2).active ]\nability(Extra Plating:392) [ enemy.round=2 ]\nability(Laser:482)\nstandby\nchange(next)",
},
["team:215"] = {
...
["code"] = "quit [ enemy(#1).active & self(#2).active & enemy.aura(Undead:242).exists & !self.ability(Ancient Blessing:611).usable ]\nif [ enemy(#2).active ]\n    use(Blinkstrike:616) [ enemy.round=1 ]\n    use(Sunlight:404)\n    use(Blinkstrike:616)\n    use(Life Exchange:277) [ enemy.hpp>30 ]\n    use(Celestial Blessing:1032)\nendif\nchange(#2) [ round=5 ]\nuse(Jadefire Lightning:1031)\nuse(Life Exchange:277)\nuse(Celestial Blessing:1032)\nuse(Sunlight:404)\nuse(Ancient Blessing:611)\nuse(Blinkstrike:616)\nchange(#1)\nuse(Weakness:471)\nuse(Darkflame:792)\nuse(Tail Sweep:122)",
},
["team:159"] = {
["name"] = "Dealing with Satyrs",
["code"] = "standby [enemy(#2).active & enemy.round=1]\nuse(Poison Protocol:1954) [enemy(#2).active & enemy.round=3]\nuse(Void Tremors:2360)\nuse(Shadow Talon:1238) [enemy(#2).active]\nuse(Shadowmeld:2253)\nuse(Void Nova:2356)\nuse(Corrosion:447)\nchange(#1)",
},
["team:504"] = {
["name"] = "Extra Pieces (Undead)",
["code"] = "use(Drain Blood:1043) [ round>1 & enemy.hpp>10 ]\nuse(Touch of the Animus:940)\nuse(Absorb:449)\nuse(Stampede:163)\nuse(Ghostly Bite:654)\nuse(Ethereal:998)\nchange(next)",
},
["team:75"] = {
["name"] = "Chi-Chi, Hatchling of Chi-Ji",
["code"] = "standby [round=3]\nability(Curse of Doom:218)\nability(Haunt:652)\nability(Creeping Fungus:743) [self.round=2]\nability(#1)\nchange(next)",
...
["code"] = "use(Headbutt:376) [ enemy(#3).active ]\nuse(Dive:564) [ enemy(#1).active & enemy.hp>302 ]\nuse(Dive:564) [ enemy(#3).active ]\nuse(Shell Shield:310) [ self.aura(Shell Shield:309).duration<2 & self.hp>240 ]\nuse(Shell Armor:1380)\nuse(#1)\nchange(next)",
},
["team:65"] = {
["name"] = "Airborne Defense Force (Flyer)",
["code"] = "quit [ self.aura(Asleep).exists ]\nchange(next) [ self.dead ]\nuse(Void Cyclone:2102)\nuse(Void Tremors:2360)\nuse(Soulrush:752)\nuse(Moonfire:595)\nuse(Shadow Talon:1238)\nuse(Dark Talon:1233)",
},
["team:106"] = {
["name"] = "Mega Bite",
["code"] = "use(Aufladen:208) [ !enemy.ability(Stachelpanzerschale:2324).usable ]\nuse(Aufziehen:459)",
...
["code"] = "quit [ self(#1).dead & enemy(#1).active ]\nuse(Dodge:312) [ enemy(#3).active ]\nuse(Burrow:159) [ enemy.aura(Undead:242).exists ]\nstandby [ enemy.aura(Undead:242).exists ]\nstandby [ enemy(#2).active & enemy.hp<700 ]\nuse(Survival:283) [ enemy(#3).active ]\nuse(Crouch:165) [ enemy(#2).active ]\nuse(Hiss:155) [ enemy.round=1 ]\nuse(Shell Armor:1380) [ enemy(#1).active ]\nuse(#1)\nchange(next)",
},
["team:184"] = {
["name"] = "Not So Bad Down Here",
["code"] = "use(Supercharge:208) [self(Runeforged Servitor:1957).active]\nuse(Call Lightning:204)\nchange(#2) [round=3]\nuse(Screech:357) [!enemy.aura(Speed Reduction:154).exists]\nuse(Feathered Frenzy:1398)\nuse(Quills:184)\nchange(#1) [self(#2).dead]\nuse(Wind-Up:459) [ !self.aura(Wind-Up:458).exists ]\nuse(Wind-Up:459) [ self.aura(Supercharged:207).exists ]\nuse(Supercharge:208)\nuse(Toxic Smoke:640)\nstandby\nchange(next)",
...
["code"] = "change(#2) [ enemy.round=1 & enemy(#2).active ]\nability(Stoneskin:436) [ self.round=1 ]\nability(Prowl:536) [ self(#1).active & enemy(#1).active ]\nability(Prowl:536) [ self(#2).active & enemy(#2).active ]\nability(Moonfire:595)\nability(#1)\nstandby\nchange(#1) [ enemy(#2).active ]\nchange(#3) [ enemy(#3).active ]",
},
["team:176"] = {
["name"] = "Cookie's Leftovers",
["code"] = "standby [ self.aura(926).exists & self.speed.fast ]\nability(334)\nability(779)\nability(115)\nchange(#2)\nability(312) [ enemy.ability(#3).usable ]\nability(574) [ self.aura(820).duration < 2 & self.speed.slow ]\nability(574) [ !self.aura(820).exists ]\nability(504)",
...
["code"] = "use(Dust Cloud:2059) [ enemy(#3).active ]\nuse(Burrow:159) [ enemy.aura(Undead:242).exists ]\nstandby [ enemy.aura(Undead:242).exists ]\nstandby [ enemy(#2).active & enemy.hp<700 ]\nuse(Stoneskin:436) [ round<3 ]\nuse(Lightning Shield:906)\nuse(Survival:283) [ enemy(#3).active ]\nuse(Flank:193) [ self.speed.fast ]\nuse(#1)\nchange(next)",
},
["team:210"] = {
["name"] = "Phyxia",
["code"] = "use(Supercharge:208) [enemy.hp>361]\nuse(Repair:278) [round=3]\nuse(Metal Fist:384)\nuse(#1)\nchange(next)",
...
["code"] = "ability(Black Claw:919) [ round=1 ]\nability(Mind Games: Ability Lockout:2390)\nability(Flock:581) [ round=3 ]\nability(Call Lightning:204)\nability(#1) [ round>7 ]\nchange(next)",
},
["team:174"] = {
["name"] = "Klutz's Battle Rat",
["code"] = "ability(124)\nability(202)\nchange(#2)\n\nability(#3) [enemy.hp<618 & enemy.type !~ 3]\nability(#3) [enemy.hp<406 & enemy.type ~ 3]\nability(#2) [!self(#2).aura(820).exists]\nability(#1)",
...
["code"] = "use(Sting:359) [round=1]\nuse(Explode:282)\nuse(Murder the Innocent:2223)\nuse(Hatred Manifest:2505) [!enemy.aura(Hatred Manifest:2504).exists]\nuse(Trample:377)\nchange(next)\n\n-- This script was generated with wow-petsim.com",
},
["team:164"] = {
["name"] = "Snail Fight!",
["code"] = "change(#1) [self(#3).played]\nchange(#2) [round=2]\nchange(#3) [round=4]\nuse(Great Sting:1966)\nstandby [round=5 & self(#2).dead]\nuse(Enrage:1392) [!self.aura(Enraged:1391).exists]\nuse(Impale:800)\nuse(Pheromones:1063)",
...
["code"] = "ability(Ion Cannon:209) [ enemy.hp<768 & enemy(#3).active ]\nability(Alert!:1585) [ enemy.hp>1726 & enemy(#3).active ]\nability(Explode:282) [ self.hp< 575 & enemy(#3).active ]\nability(Supercharge:208) [ round=2 ]\nability(Drill Charge:1921)\nability(Toxic Smoke:640) [ !enemy(#1).active ]\nability(Wind-Up:459)\nability(Supercharge:208)\nability(Ion Cannon:209)\nstandby\nchange(next)",
},
["team:554"] = {
["name"] = "Cursed Spirit",
["code"] = "standby [ enemy(#1).active & enemy.aura(Undead:242).exists ]\nability(Howl:362)\nability(Prowl:536) [ enemy(#1).active ]\nability(Deflection:490) [ enemy.aura(Dodge:311).exists ]\nability(Deflection:490) [ enemy.aura(Flying:341).exists ]\nability(Deflection:490) [ enemy.aura(Underground:340).exists ]\nability(Deflection:490) [ enemy.aura(Silk Cocoon:505).exists ]\nability(Deflection:490) [ enemy.aura(Underwater:830).exists ]\nability(Sandstorm:453)\nability(Emerald Presence:597) [ self.aura(Emerald Presence).duration<2 ]\nability(Emerald Dream:598) [ self.hpp<65 ]\nability(#1)\nchange(next)",
},
["team:226"] = {
["name"] = "Do You Even Train? (Humanoid)",
["code"] = "standby [self(#2).active & self.speed.slow & enemy(#3).active & enemy.ability(Dive:564).usable]\nability(Howl:362) [round=1]\nability(Dodge:312) [enemy.aura(Underwater:830).exists]\nability(Dodge:312) [enemy.aura(Attack Boost:485).exists]\nability(Howl:362) [enemy(#1).active]\nability(Deflection:490) [enemy(#3).active & enemy.ability(Headbutt:376).usable]\nability(Dark Fate:2432)\nability(Rampage:124) [enemy.ability(Headbutt:376).duration>2]\nability(#1)\nchange(next)",
...
["code"] = "change(#1) [self(#3).active]\nuse(Armageddon:1025)\nuse(Great Sting:1966)\nuse(Enrage:1392) [!self.aura(Enraged:1391).exists]\nuse(Paralyzing Venom:1559) [round!=3]\nchange(next)\n\n-- This script was generated with wow-petsim.com",
},
["team:119"] = {
["name"] = "Living Statues Are Tough",
["code"] = "use(212) [round=1]\nuse(652)\nuse(581) [enemy.aura(918).exists]\nuse(919)\nchange(next)",
...
["code"] = "if [ self(Darkmoon Zeppelin:339).active ]\n    use(Explode:282) [ enemy(Shelby:2972).active & enemy.hp <=618 ]\n    use(Decoy:334)\n    use(Missile:777)\nendif\nuse(Wind-Up:459) [ self(Iron Starlette:1387).active & enemy(Tinyhoof:2973).active ]\nif [ self(Iron Starlette:1387).active & enemy(Glitterwing:2974).active ]\n    use(Toxic Smoke:640) [ !enemy.aura(Toxic Smoke:639).exists ]\n    use(Toxic Smoke:640) [ self(Iron Starlette:1387).hp<500 ]\n    use(Wind-Up:459) [ self.aura(Wind-Up:458).exists ]\n    use(Wind-Up:459)\nendif\nif [ self(Lil' Bling:1320).active ]\n    use(Blingtron Gift Package:989)\n    use(Make it Rain:985) [ !enemy.aura(Make it Rain:986).exists ]\n    use(Inflation:1002)\nendif\nchange(next)",
},
["team:529"] = {
["name"] = "Thenia's Loyal Companions (Aquatic)",
["code"] = "use(Moonfire:595) [ enemy(#3).active & self.hpp>50.5 ]\nuse(Sewage Eruption:2062) [ !enemy(#2).active ]\nuse(Moonfire:595) [ enemy.aura(Sewage Eruption:2063).duration=1 ]\nuse(Nether Blast:608)\nuse(Whirlpool:513) [ self.round=1 ]\nuse(Stampede:163)\nstandby\nchange(next)",
},
["team:367"] = {
...
["code"] = "use(Railgun:712)\nuse(Decoy:334)\nuse(Flamethrower:503)\nuse(#1)\nchange(next)",
},
["team:482"] = {
["name"] = "Resilient Survivors (Dragon)",
["code"] = "change(#3) [ enemy(#3).active ]\nuse(Howl:362)\nuse(Surge of Power:593) [ !self.aura(Blinding Poison:1048).exists & round>2 ]\nuse(Arcane Storm:589) [ weather(Scorched Earth:171) ]\nuse(Breath:115)\nuse(Mana Surge:489) [ self.aura(Dragonkin:245).exists & enemy.hp<731 ]\nuse(Mana Surge:489) [ enemy.hp<488 ]\nuse(Frost Breath:782)\nstandby\nchange(next)",
},
["team:444"] = {
...
["code"] = "standby [ round=2 ]\nuse(Stun Seed:402)\nuse(Toxic Smoke:640) [ round=5 ]\nuse(Fel Immolate:901)\nuse(Call Lightning:204) [ enemy.aura(Stunned:927).exists ]\nuse(Bash:348) [ enemy.aura(Rooted:248).duration=1 ]\nuse(Wild Winds:514)\nuse(Healing Wave:123) [ enemy(#3).active & enemy.round=2 ]\nuse(Corrosion:447) [ enemy(#3).active & !enemy.aura(Corrosion:446).exists ]\nuse(Ooze Touch:445)\nchange(next)",
},
["team:513"] = {
["name"] = "Mighty Minions of Maldraxxus (Flyer)",
["code"] = "ability(Sludge Belch:2291) [ round=1 ]\nability(Toxic Bite:2113) [ round=2 ]\nability(Consume Magic:1231)\nability(Sludge Belch:2291)\nability(Toxic Bite:2113)\nchange(#2)\nability(Alpha Strike:504) [ enemy(#1).active ]\nability(Decoy:334)\nability(Haywire:916)\nability(Alpha Strike:504)\nability(Fire Quills:1027) [ enemy(#2).active ]\nability(Ethereal:998) [ enemy.aura(Flying:341).exists ]\nability(Tranquility:254) [ !self.aura(Tranquility:255).exists ]\nability(Fire Quills:1027)",
},
["team:47"] = {
["name"] = "Are They Not Beautiful? (Dragon)",
["code"] = "use(Mana Surge:489) [weather(Arcane Winds:590).duration>1]\nuse(Surge of Power:593) [enemy(#3).active & enemy.hp<1099]\nuse(Surge of Power:593) [enemy(#3).active & self.aura(Dragonkin:245).exists]\nuse(Arcane Storm:589)\n\nuse(Arcane Blast:421)\nuse(#1)\n\nchange(next)",
...
["code"] = "use(Conflagrate:179) [ enemy.aura(Flamethrower:502).exists ]\nuse(Flamethrower:503)\nchange(next)",
},
["team:177"] = {
["name"] = "Tremblor - Rare",
["code"] = "ability(Blistering Cold:786)\nability(Chop:943) [!enemy.aura(Bleeding:491).exists]\nability(BONESTORM!!:1762)\n\nability(Primal Cry:920)\nability(Black Claw:919) [!enemy.aura(Black Claw:918).exists]\nability(Hunting Party:921)\n\nability(#1)\nchange(next)",
...
["code"] = "ability(Wing Buffet:1756) [ round=3 ]\nability(Wild Magic:592) [ !enemy.aura(Wild Magic:591).exists ]\nability(Scorched Earth:172) [ self.round=1 ]\nability(Healing Flame:168) [ self.round=2 ]\nability(Healing Flame:168) [ enemy.round=1 & enemy(#3).active ]\nability(Lift-Off:170) [ enemy.hpp<30 & enemy(#3).active ]\nability(Thunderbolt:779)\nability(#1)\nchange(next)",
},
["team:57"] = {
["name"] = "Prince Wiggletail",
["code"] = "ability(Shadow Shock:422) [round=1]\nability(Curse of Doom:218)\nability(Haunt:652)\nability(#1) [enemy.aura(Shattered Defenses:542).exists]\nability(Flock:581)\nchange(next)",
...
["code"] = "change(#1) [ self(#3).active & enemy(#1).active ]\nchange(#2) [ self(#1).dead & enemy(#2).active ]\nability(Shell Shield:310) [ self.round=1 & enemy(#1).active ]\nability(Shell Shield:310) [ enemy(#2).active & enemy.round=1 ]\nability(Flurry:360) [ enemy(#3).active & enemy.aura(Rooted:248).exists ]\nability(Dodge:312)\nability(Flurry:360) [ self.aura(Dodge:311).exists ]\nability(Burrow:159)\nability(#1)\nchange(#3)",
},
["team:36"] = {
["name"] = "Flow - Rare",
["code"] = "use(Haunt:652)\nuse(Black Claw:919) [!enemy.aura(Black Claw:918).exists]\nuse(Hunting party:921)\nuse(Leap:364)\nchange(next)\n\n--Script created by Anolaszun#1423",
...
["code"] = "quit [ ally(#1).dead & round = 5 ]\nuse(Call Blizzard:206)\nuse(Ice Tomb:624)\nuse(Ice Lance:413)\nuse(Bubble:934) [ ally.hp < 700 ]\nuse(Swarm of Flies:232) [ !enemy.aura(Swarm of Flies:231).exists ]\nuse(Tongue Lash:228)\nuse(Water Jet:118) [ enemy(Bloog:2980).active ]\nuse(Water Jet:118) [ enemy(Bone Crusher:2981).active ]\nuse(Nature's Ward:574) [ !ally.aura(Nature's Ward:820).exists & round < 18 ]\nuse(Dive:564)\nuse(Water Jet:118)\nchange(next)",
},
["team:526"] = {
["name"] = "Thenia's Loyal Companions (Magic)",
["code"] = "change(#3) [ self.dead & enemy(#3).active ]\nuse(Arcane Storm:589)\nuse(Soulrush:752) [ !enemy(#1).active ]\nuse(Surge of Power:593) [ !enemy(#1).active ]\nuse(Drain Blood:1043) [ self.hpp<50 ]\nuse(#1)\nstandby\nchange(next)",
},
["team:360"] = {
...
["code"] = "change(#3) [ round=5 ]\nquit [ round=3 & self(#1).dead ]\nability(Swarm of Flies:232) [ round=1 ]\nability(Call Lightning:204)\nstandby [ round=3 ]\nability(Blackout Kick:227) [ enemy(#1).active ]\nability(Sandstorm:453)\nability(Blackout Kick:227)\nability(Booby-Trapped Presents:1080) [ enemy(#2).active & enemy.hpp<31 ]\nability(Greench's Gift:1076)\nability(Club:1079)\nchange(next)",
},
["team:521"] = {
["name"] = "Thenia's Loyal Companions (Humanoid)",
["code"] = "ability(Gift of Winter's Veil:586)\nability(Booby-Trapped Presents:1080) [ enemy(#2).active ]\nability(Call Blizzard:206) [ weather(Blizzard:205).duration<2 ]\nability(Ice Lance:413)\nstandby\nchange(next)",
},
["team:89"] = {
["name"] = "Sputtertube",
["code"] = "use(Black Claw:919) [round=1]\nuse(Flock:581)\nchange(#2)\nuse(Flamethrower:503) [!enemy(Sputtertube:2736).aura(Flamethrower:502).exists]\nuse(Burn:113)",
...
["code"] = "use(Explode:282) [enemy.aura(Toxic Smoke:639).exists]\n\nif [enemy.aura(Flame Breath:500).exists]\nuse(Razor Talons:2237) [!enemy.aura(Razor Talons:2238).exists]\nuse(Armageddon:1025) [enemy.aura(Razor Talons:2238).exists]\nendif\n\nuse(Toxic Smoke:640)\nuse(#1)\nchange(next)",
},
["team:196"] = {
["name"] = "Unbreakable",
...
["code"] = "change(#3) [ enemy(#3).active ]\nuse(Supercharge:208) [ enemy(#1).active & enemy.round=1 ]\nuse(Supercharge:208) [ enemy(#2).active & enemy.round=2 ]\nuse(Supercharge:208) [ enemy(#3).active & enemy.round=3 ]\nuse(Explode:282) [ round=4 ]\nuse(Water Jet:118)\nuse(Wind-Up:459)\nuse(Ion Cannon:209) [ self.aura(Supercharged:207).exists ]\nstandby\nchange(next)",
},
["team:362"] = {
...
["code"] = "change(next) [ self.dead ]\nuse(Pinch:2067) [ enemy.aura(Stunned:927).exists ]\nuse(Bubble:934)\nuse(Pinch:2067)\nuse(Tongue Lash:228) [ enemy.round=1 ]\nuse(Ice Tomb:624)\nuse(Call Blizzard:206)\nstandby [ enemy.aura(Undead:242).exists ]\nuse(Hiss:155) [ enemy.round=1 ]\nuse(Shell Armor:1380) [ enemy.round=2 ]\nuse(Skitter:626)",
},
["team:28"] = {
["name"] = "Taralune",
...
["code"] = "ability(Crush:406) [ enemy(#2).dead & enemy(#3).dead & self(#1).active ]\nability(Photosynthesis:268) [ round=4 ]\nability(Sunlight:404)\nability(Photosynthesis:268) [ !self.aura(Photosynthesis:267).exists ]\nchange(next)\nchange(#1)",
},
["team:495"] = {
["name"] = "Uncomfortably Undercover (Critter)",
["code"] = "use(Sunlight:404) [ !self(#2).dead ]\nuse(Sunlight:404) [ !weather(Sunny Day:403).exists ]\nuse(Nature's Touch:573)\nuse(Nature's Ward:574) [ self.round=1 ]\nuse(Bleat:539)\nchange(#1)\nchange(#2)\nuse(Skitter:626)\nuse(Dodge:312) [ self.speed.fast ]\nuse(Scratch:119)\nchange(next)",
},
["team:282"] = {
["name"] = "Major Payne",
...
["code"] = "use(Make it Rain:985) [ !enemy.aura(Make it Rain:986).exists ]\nuse(Inflation:1002)\nuse(Toxic Smoke:640) [ self.aura(Mechanical:244).exists ]\nuse(Wind-Up:459) [ self.aura(Supercharged:207).exists ]\nuse(Wind-Up:459) [ !self.aura(Wind-Up:458).exists ]\nuse(Supercharge:208)\nuse(Wind-Up:459)\nuse(Call Lightning:204)\nuse(Haywire:916)\nuse(Laser:482)\nchange(next)",
},
["team:250"] = {
["name"] = "To a Land Down Under (Undead)",
["code"] = "use(Enrage:1392) [!self.aura(Enraged:1391).exists && self.ability(Soulrush:752).usable]\nuse(Reflective Shield:1105) [enemy(Murrey:3558).active]\nuse(Spiritfire Bolt:1066) [enemy.hp < 216]\nuse(Soulrush:752)\nuse(Spiritfire Bolt:1066)\n\nuse(Toxic Smoke:640) [!enemy.aura(Toxic Smoke:639).exists]\nuse(Slime:1763)\n\nchange(next)",
...
["code"] = "use(Consume Magic:1231)\nuse(Sunlight:404)\nuse(Photosynthesis:268) [ self.round=2 ]\nchange(next)\nuse(Photosynthesis:268)",
},
["team:551"] = {
["name"] = "Chaos Pup",
["code"] = "change(next) [self.dead]\nuse(Metal Fist:384) [round=1]\nuse(Reflective Shield:1105)\nuse(Ion Cannon:209)\n\nuse(#2)\nuse(#1)",
},
["team:94"] = {
["name"] = "Mighty Minions of Maldraxxus",
["code"] = "if [self(#1).active]\nuse(Curse of Doom:218) [self.round==1]\nuse(Consume Magic:1231) [self.round==2]\nuse(Shadow Shock:422)\nendif\n\nif [enemy(#2).active]\nchange(#2) [self(#1).dead]\nuse(Supercharge:208)\nuse(Ion Cannon:209)\nendif\n\nif [!self(#3).played]\nchange(#3)\nendif\n\nuse(Arcane Storm:589)\nuse(Mana Surge:489)\nuse(Tail Sweep:122)\n\nif [enemy(Chipper:2982).ability(Lift-Off:170).usable]\nuse(Supercharge:208)\nendif\n\nif [self(#2).aura(Supercharged:207).exists]\nuse(Ion Cannon:209)\nendif\n\nuse(Alert!:1585)",
...
["code"] = "change(#3) [ enemy(#3).aura(Mechanical:244).exists & enemy(#2).aura(Mechanical:244).exists & self.aura(Ice Barrier:480).exists ]\nchange(#2) [ enemy(#1).active & enemy.aura(Stunned:927).exists ]\nchange(#2) [ enemy(#3).active & enemy.aura(Stunned:927).exists ]\nchange(#2) [ enemy(#1).dead & enemy(#2).aura(Resilient:924).duration=1 & enemy(#2).active ]\nchange(#1) [ self.aura(Ice Barrier:480).exists ]\nability(Ice Tomb:624) [ enemy.aura(Extra Plating:391).duration=3 ]\nability(Ice Barrier:479) [ enemy.aura(Ice Tomb:623).exists ]\nability(Stun Seed:402)\nability(Leech Seed:745)\nability(Spirit Spikes:914)\nability(#1)",
},
["team:132"] = {
["name"] = "Crawg in the Bog",
["code"] = "ability(Alert!:1585) [round=1]\nability(Supercharge:208)\nability(Ion Cancon:209)",
...
["code"] = "quit [ self(#2).hp < 1000 & enemy(#1).active ]\nability(Black Claw:919) [ round=1 ]\nability(Spirit Claws:974) [ enemy(#1).active ]\nability(Prowl:536)\nability(Moonfire:595)\nability(#1)\nchange(next)",
},
["team:153"] = {
["name"] = "Thundering Pandaren Spirit",
...
["code"] = "use(Rabid Strike:666) [ round=1 ]\nuse(Stampede:163) [ round=2 ]\nuse(Corpse Explosion:663)\nif [ enemy(#1).active ]\n    use(Spiritfire Bolt:1066) [ enemy.hp<357 ]\n    use(Soulrush:752) [ enemy.hp<696 ]\nendif\nif [ enemy(#2).active ]\n    use(Soulrush:752) [ enemy.hp<772 ]\n    use(Soulrush:752) [ enemy.hp<1467 & self.aura(Enraged:1391).exists ]\n    use(Spiritfire Bolt:1066) [ enemy.hp<433 ]\n    use(Enrage:1392) [ !self.aura(Enraged:1391).exists & !self.aura(Undead:242).exists ]\nendif\nuse(Soulrush:752) [ enemy(#3).active ]\nuse(Spiritfire Bolt:1066)\nuse(Prowl:536) [ self.aura(Blinding Poison:1048).exists ]\nuse(Rake:492) [ self.aura(Prowl:543).exists ]\nuse(Pounce:535)\nchange(next)",
},
["team:257"] = {
["name"] = "Are They Not Beautiful? (Beast)",
["code"] = "use(Feathered Frenzy:1398) [ round=1 ]\nuse(Gift of Winter's Veil:586)\nuse(Pounce:535)\nuse(Prowl:536)\nuse(Arcane Dash:1536)\nuse(Moonfire:595)\nchange(next)",
...
["code"] = "use(Swarm of Flies:232) [ !enemy.aura(Swarm of Flies:231).exists ]\nuse(Crouch:165)\nuse(Consume Magic:1231) [ enemy.aura(Dodge:2060).exists ]\nstandby [ enemy.aura(Undead:242).exists ]\nstandby [ enemy.aura(Dodge:2060).exists ]\nuse(Ghostly Bite:654) [ enemy(#1).active & enemy.hp<561 ]\nuse(Ghostly Bite:654) [ enemy(#3).active ]\nuse(Hoof:493) [ self.aura(Undead:242).exists ]\nuse(Consume Magic:1231) [ self.aura(Spore Shrooms:747).exists ]\nuse(Consume Magic:1231) [ self.aura(Spore Burst:748).exists ]\nstandby [ enemy.aura(Dodge:2060).exists ]\nuse(#1)\nstandby\nchange(next)",
},
["team:232"] = {
...
["code"] = "use(#1) [ round=1 ]\nchange(#1) [ self.dead ]\nchange(#2) [ round=3 ]\nuse(Celestial Blessing:1032) [ self.aura(Sanctified Ground:1033).duration<2 ]\nuse(Breath:115) [ self(#1).active & self.aura(Dragonkin:245).exists ]\nuse(Life Exchange:277) [ self.hp<800 & enemy.ability(Headbutt:376).usable ]\nuse(Life Exchange:277) [ self.hp<700 & !enemy.ability(Headbutt:376).usable ]\nuse(Hiss:155) [ enemy(#2).active ]\nuse(Rampage:124) [ enemy(#2).active ]\nuse(Arcane Storm:589) [ enemy.hp<217 & self.power>340 ]\nuse(Arcane Storm:589) [ enemy.hp<196 & self.power>304 ]\nuse(Tail Sweep:122) [ enemy.hp<452 & self.power>340 ]\nuse(Tail Sweep:122) [ enemy.hp<407 & self.power>304 ]\nuse(Arcane Storm:589)\nuse(Arcane Storm:589)\nuse(Mana Surge:489) [ weather(Arcane Winds:590) ]\nuse(#1)\nstandby",
},
["team:516"] = {
["name"] = "Mighty Minions of Maldraxxus (Magic)",
["code"] = "standby [ enemy.aura(Curse of Doom:217).duration=1 & enemy.hp<928 ]\nstandby [ enemy(#2).active & self(#1).active ]\nstandby [ enemy(#2).active & self.round=2 ]\nstandby [ enemy(#3).active & enemy.round=2 ]\nuse(Curse of Doom:218)\nuse(Amplify Magic:488)\nuse(Life Exchange:277) [ self.hpp<50 ]\nuse(Arcane Blast:421) [ enemy.hp<241 ]\nuse(Surge of Power:593) [ enemy(#3).active & enemy.hp<1204 ]\nuse(Soulrush:752)\nuse(#1)\nchange(next)",
},
["team:471"] = {
["name"] = "Eyegor's Special Friends (Humanoid)",
["code"] = "ability(Nether Gate:466) [ round=2 ]\nability(Flamethrower:503) [ round=1 ]\nability(Flamethrower:503) [ !enemy.aura(Flamethrower:502).exists & self.aura(Toxic Wound:2112).exists ]\nability(Booby-Trapped Presents:1080)\nability(Greench's Gift:1076)\nability(Curse of Doom:218) [ self.round=1 ]\nability(Lovestruck:772) [ self.round>2 ]\nability(#1)\nchange(next)",
},
["team:143"] = {
...
["code"] = "ability(Mind Games: Ability Lockout:2390)\nability(Immolate:178) [ !enemy.aura(Immolate:177).exists ]\nability(Conflagrate:179)\nability(Flame Breath:501)\nability(Call Lightning:204)\nstandby [ self(#1).active & self(#2).dead ]\nchange(#1) [ self(#2).dead ]\nchange(next)",
},
["team:62"] = {
["name"] = "Silence",
["code"] = "quit [ round<4 & self(#1).dead & !enemy.aura(Shattered Defenses:542).exists ]\ntest(\"Please finish the fight with standard attacks.\") [ self(#3).active ]\nuse(Black Claw:919) [ round=1 ]\nuse(Swarm:706)\nuse(Flock:581)\nuse(Arcane Storm:589)\nuse(Mana Surge:489)\nchange(#2)",
...
["code"] = "use(Extra Plating:392) [ round=1 ]\nuse(Make it Rain:985)\nuse(Inflation:1002)\nchange(#2) [ self(#1).dead ]\nuse(Supercharge:208) [ self.aura(Wind-Up).exists ]\nuse(Wind-Up:459)\nchange(#3) [ self(#2).dead ]\nuse(Extra Plating:392) [ !enemy.aura(Fel Immolate).exists ]\nuse(Call Lightning:204)\nuse(Fel Immolate:901)",
},
["team:139"] = {
["name"] = "Goz Banefury",
...
["code"] = "ability(Curse of Doom:218)\nability(Mind Games: Ability Lockout:2390)\nability(Haunt:652)\nability(Rabid Strike:666) [ self.round=1 ]\nability(Dead Man's Party:1093) [ self.round=1 ]\nability(#1) [ round>4 ]\nchange(next)",
},
["team:280"] = {
["name"] = "Narrok",
["code"] = "ability(453)\nability(406)\nstandby",
...
["code"] = "change(#2) [ self.aura(Uncanny Luck:251).exists ]\nability(Mind Games: Ability Lockout:2390)\nability(Uncanny Luck:252) [ round=3 ]\nability(Black Claw:919) [ !enemy.aura(Black Claw:918).exists ]\nability(#1)\nchange(next)",
},
["team:96"] = {
["name"] = "Micro Defense Force",
["code"] = "if [enemy(#3).active]\nchange(#3)\nuse(Supercharge:208)\nuse(Ion Cannon:209)\nendif\n\nchange(#2) [round=5]\nuse(Stun Seed:402) [round=1]\nuse(Poison Lash:398) [round=4]\nuse(Poison Lash:398) [!enemy.aura(Poisoned:379).exists]\nuse(Leech Seed:745)\nuse(Fel Immolate:901) [enemy(#1).active]\nuse(Fel Immolate:901) [enemy(#3).active & enemy.round=1]\nuse(Wing Buffet:1756) [enemy.aura(Prowl:543).exists]\nuse(Wild Magic:592) [!enemy.aura(Wild Magic:591).exists]\nuse(Fel Immolate:901)\nuse(Poison Lash:398)\nchange(#1)",
...
["code"] = "change(#2) [ self(#1).dead & enemy(#1).active ]\nchange(#2) [ self(#1).dead & enemy(#2).active ]\nchange(#1) [ self(#2).dead & enemy(#3).active ]\nuse(Absorb:449) [ round=1 ]\nuse(Prismatic Barrier:444) [ round=2 ]\nchange(Roach:424) [ round=3 ]\nuse(Apocalypse:519) [ round=4 ]\nuse(Scratch:119) [ round=5 ]\nchange(Prismatic Softshell:2698) [ round=6 ]\nuse(Absorb:449) [ round=7 ]\nuse(Prismatic Barrier:444) [ round=8 ]\nstandby [ round=9 ]\nuse(Dive:564) [ round=10 ]\nuse(Absorb:449) [ round=12 ]\nuse(Absorb:449) [ round=13 ]\nuse(Prismatic Barrier:444) [ round=14 ]\nstandby [ round=15 ]\nuse(Dive:564) [ round=16 ]\nuse(Absorb:449) [ round=18 ]\nuse(Absorb:449) [ round=19 ]\nuse(Scratch:119) [ enemy(#3).active ]\nuse(Shell Shield:310) [ !self.aura(Shell Shield:309).exists ]\nuse(Dive:564) [ enemy(#3).active & self.aura(Shell Shield:309).duration=2 ]\nuse(Dive:564) [ enemy(#3).active & enemy.ability(Predatory Strike:518).usable ]\nuse(Ooze Touch:445)",
},
["team:481"] = {
...
["team:445"] = {
["name"] = "Miniature Army",
["code"] = "use(Swarm of Flies:232) [round=1]\nchange(#2) [round=2]\nuse(Armageddon:1025)\nuse(Booby-Trapped Presents:1080) [round=4]\nuse(Call Blizzard:206) [round=5]\nuse(Ice Lance:413)\nuse(#1)\nchange(#3)\n\n-- This script was generated with wow-petsim.com",
},
["team:150"] = {
["name"] = "Failed Experiment",
["code"] = "use(Glowing Toxin:270) [ round=1 ]\nuse(Explode:282)\nuse(Supercharge:208)\nuse(Ion Cannon:209)\nchange(#2)",
...
["code"] = "use(#3) [ enemy.aura(Bleeding:491).exists ]\nuse(#1)\nchange(next)",
},
["team:78"] = {
["name"] = "Kelpstone",
["code"] = "change(#2) [self(#1).dead]\nability(Exposed Wounds:305)\nstandby [round=2]\nability(Flock:581) [round=4]\nability(Black Claw:919)",
...
["code"] = "quit [ !enemy(#1).dead & self(#1).dead ]\nuse(Bone Barrage:1091)\nuse(Death and Decay:214) [ round=2 ]\nif [ !self.aura(Undead:242).exists ]\n    use(Lift-Off:170) [ enemy(#2).ability(#2).usable ]\n    use(Consume Corpse:665) [ self(#2).hp<691 ]\nendif\nuse(Soul Ward:751) [ enemy(#3).active & enemy.round=2 ]\nuse(#1)\nchange(next)",
},
["team:277"] = {
...
["code"] = "change(Anomalus:2842) [ round~3,9 ]\nchange(Empyreal Manafiend:1765) [ round=6 ]\nuse(Arcane Explosion:299) [ round=1 ]\nuse(Prismatic Barrier:444) [ !enemy(Slugger:3000).dead ]\nuse(Arcane Explosion:299)\nuse(Poison Protocol:1954)\nuse(Void Nova:2356)\nuse(Stay a While and Listen:2380)\nuse(Arcane Slash:1353)\nchange(Empyreal Manafiend:1765)\nchange(next)",
},
["team:346"] = {
...
["code"] = "change(#3) [ enemy(#3).active ]\nstandby [ self(#1).active & enemy(#2).hp<777 ]\nuse(Fire Shield:1754) [ enemy(#1).active ]\nuse(Lightning Shield:906) [ enemy(#1).active ]\nuse(Extra Plating:392)\nuse(Call Lightning:204) [ enemy(#2).hp<777 ]\nuse(Supercharge:208) [ enemy(#3).hp<1919 & !enemy.ability(Rain Dance:1062).usable ]\nuse(Ion Cannon:209) [ self.aura(Supercharged:207).exists ]\nuse(#1)\nstandby\nchange(next)",
},
["team:527"] = {
["name"] = "Thenia's Loyal Companions (Elemental)",
["code"] = "change(#3) [ self.dead & enemy(#1).active ]\nchange(#3) [ self.dead & enemy(#2).dead & !enemy(#1).dead ]\nchange(#2) [ self.dead ]\nuse(Geyser:418)\nuse(#1) [ enemy(#2).active & enemy.aura(Stunned:927).exists & enemy(#1).hp<373 & !enemy(#1).dead ]\nuse(Jadeskin:431) [ enemy(#1).active & enemy.aura(Stunned:927).exists & !enemy(#2).dead ]\nuse(Jadeskin:431) [ self.aura(Jadeskin:430).duration<2 & self.hp>165 ]\nuse(Call Blizzard:206) [ enemy(#3).active ]\nuse(Call Blizzard:206) [ enemy.hp>444 ]\nuse(Deep Freeze:481) [ weather(Blizzard:205) & !enemy.aura(Geyser:417).exists & enemy.hp>444 & !enemy.aura(Rooted:248).exists ]\nuse(Call Lightning:204) [ enemy(#3).active ]\nuse(#1)\nstandby\nchange(next)",
},
["team:71"] = {
["name"] = "Lurking In The Shadows",
["code"] = "use(Appel de la foudre:204)\nuse(Détraqué:916)",
...
["code"] = "use(Mind Games: Health:2388)\nuse(Arcane Storm:589)\nuse(Surge of Power:593)\nuse(Life Exchange:277)\nuse(Inner Vision:216)\nuse(Mana Surge:489)\nchange(next)",
},
["team:195"] = {
["name"] = "Mining Monkey",
["code"] = "ability(Launch Rocket:293) [ !self.aura(Setup Rocket:294).exists ]\nability(Launch Rocket:293) [ self.round>2 ]\nability(Blingtron Gift Package:989) [ !enemy(#1).active ]\nability(#1)\nchange(next)",
...
["code"] = "use(Pinch:2067) [ round=1 & self.speed.fast ]\nuse(Sandstorm:453)\nuse(Call Lightning:204) [ enemy(#2).hp<1043 ]\nuse(Shell Armor:1380)\nuse(Phase Shift:764) [ enemy.ability(Amplify Magic:488).usable ]\nuse(Expunge:450)\nuse(#1)\nchange(next)",
},
["team:68"] = {
["name"] = "Elderspawn of Nalaada",
["code"] = "ability(#1) [enemy.aura(Shattered Defenses:542).exists]\nability(#2) [self.round=1]\nability(#3)\nchange(next)",
...
["code"] = "ability(Healing Flame:168) [ enemy(#1).active & enemy.ability(Mudslide:572).usable ]\nability(Lift-Off:170) [ enemy(#1).active & enemy.ability(Burrow:159).usable ]\nability(Thunderbolt:779) [ enemy(#3).active ]\nability(Call Lightning:204)\nability(Arcane Storm:589)\nability(Mana Surge:489)\nability(#1)\nchange(next)",
},
["team:138"] = {
["name"] = "Wastewalker Shu",
...
["team:63"] = {
["name"] = "Natural Defenders",
["code"] = "change(#3) [ round=7 ]\nchange(#2) [ round=2 ]\nuse(Thunderbolt:779)\nuse(Call Lightning:204)\nuse(Peck:112) [ !enemy(#1).active ]\nuse(Whirling Talons:2458)\nuse(Maul:345)\nuse(Time Bomb:602)\nuse(Armageddon:1025)\nchange(#1)",
},
["team:107"] = {
["name"] = "Watch Where You Step",
["code"] = "ability(Curse of Doom:218)\nability(Inflation:1002) [enemy.aura(Shattered Defenses:542).duration<2]\nability(#1) [self(#3).active]\nability(#3)\nchange(next)",
...
["code"] = "ability(Portal:1125) [ round=1 ]\nability(Arcane Blast:421)\nability(Elementium Bolt:606)\nability(Crystal Overload:263) [ round=4 ]\nability(Feedback:484)\nability(Drain Power:486) [ enemy(#3).active ]\nability(Illuminate:460) [ enemy(#3).active ]\nability(Blinkstrike:616)\nchange(next)",
},
["team:21"] = {
["name"] = "My Beast's Bidding",
["code"] = "quit [!self(#3).exists]\n\nchange(next) [self.dead]\nchange(#3) [self(#2).played]\n\nuse(#2) \nuse(#3) [self(#1).active]\nuse(#3) [enemy(#2).dead]\n\nuse(#1)\nstandby",
...
["code"] = "standby [ self.aura(Asleep:498).exists & self(Puddle Terror:1568).active ]\nstandby [ self.aura(Asleep:498).exists & self(Magical Crawdad:132).active & !self.aura(Wish).exists ]\nability(Nature's Ward:574) [ !self.aura(Nature's Ward:820).exists ]\nability(Sunlight:404)\nability(Wish:273)\nability(Renewing Mists:511) [ !self.aura(Renewing Mists:510).exists & self.aura(Wish).exists ]\nchange(Emerald Turtle:564) [ self(Puddle Terror:1568).dead ]\nuse(Emerald Bite)\nuse(Surge) [ self(Puddle Terror:1568).dead ]\nchange(Puddle Terror:1568)\nchange(Magical Crawdad:132)",
},
["team:561"] = {
["name"] = "Netherfist",
...
["code"] = "change(#3) [ enemy(#3).active ]\nuse(Surge of Power:593) [ weather(Arcane Winds:590) ]\nuse(Arcane Storm:589) [ weather(Scorched Earth:171) ]\nuse(Arcane Explosion:299)\nuse(Inner Vision:216) [ self.round=1 ]\nuse(Mana Surge:489)\nuse(Interrupting Gaze:474)\nuse(Prowl:536) [ self.aura(Blinding Poison:1048).exists ]\nuse(Rake:492) [ self.aura(Prowl:543).exists ]\nuse(Pounce:535)\nchange(next)",
},
["team:240"] = {
["name"] = "Are They Not Beautiful? (Undead)",
["code"] = "use(beam:1035) [ round = 1 ]\nuse(rush:752)\nuse(filler:1066)\nchange(next)\ntest(Bad RNG, clean up somehow)",
...
["code"] = "use(Pheromones:1063) [ round=2 ]\nuse(Call Lightning:204) [ enemy(#3).active & weather(Lightning Storm).duration=1 ]\nuse(Call Lightning:204) [ enemy(#3).hp<953 & weather(Lightning Storm) ]\nuse(Call Lightning:204) [ enemy(#3).hp<732 ]\nuse(Thunderbolt:779) [ enemy(#3).active ]\nuse(#1) [ enemy(#2).active & self(#3).active ]\nuse(Call Lightning:204)\nuse(#1)\nchange(next)",
},
["team:105"] = {
["name"] = "Fight Night: Sir Galveston",
["code"] = "change(#3) [self(#2).played]\nuse(Armageddon:1025) [round=4]\nuse(Zeitbombe:602) [round=3]\nuse(Flammenatem:501)\nuse(Tiefer Atem:169) [enemy(#2).active]\nuse(Dunkelheit herbeirufen:256)\nchange(#2)",
...
["code"] = "ability(Sweep:457) [ enemy(#1).active ]\nability(Clean-Up:456) [ enemy(#2).active ]\nability(Broom:452)\nstandby [ enemy(#3).active & enemy.round=2 ]\nstandby [ enemy.aura(Dodge:2060).exists ]\nability(Acidic Goo:369) [ !enemy.aura(Acidic Goo:368).exists ]\nability(Corrosion:447) [ !enemy.aura(Corrosion:446).exists ]\nability(Ooze Touch:445)\nability(Phase Punch:1765) [ enemy(#3).active ]\nability(Evanescence:440) [ enemy(#1).active & enemy.ability(#2).usable ]\nability(Evanescence:440) [ enemy(#1).active & enemy(#1).aura(Undead:242).exists ]\nability(Nether Blast:608)\nstandby\nchange(next)",
},
["team:87"] = {
...
["code"] = "standby [ enemy(#2).active & enemy(#3).dead ]\nchange(#2) [ round=16 ]\nability(Sunlight:404) [ self(#1).active ]\nif [ self(#2).active ]\n    ability(Cosmic Smash:1764) [ round~17,20 ]\n    ability(Light of Creation:2440)\n    ability(Sunlight:404)\nendif\nif [ self(#3).active ]\n    ability(Evanescence:440)\n    ability(Wish:273)\n    ability(#1) [ enemy(#3).active & !enemy.aura(Undead:242).exists ]\nendif\nchange(next)\nchange(#1)",
},
["team:453"] = {
["name"] = "Tiny, Expensive, and Deadly",
["code"] = "use(Wind-Up:459) [round~1,5]\nuse(Drill Charge:1921) [round=2]\nuse(Explode:282)\nuse(Time Bomb:602)\nuse(Armageddon:1025)\nuse(Arcane Storm:589)\nuse(Mana Surge:489)\nchange(#1)",
},
["team:179"] = {
["name"] = "Blackmane",
...
["code"] = "use(Poison Fang:152) [round=1]\nuse(Pheromones:1063)\nuse(Puncture Wound:1050)\nuse(Minefield:634)\nuse(Explode:282)\nuse(Devour:538)\nuse(Rampage:124)\nchange(next)",
},
["team:565"] = {
["name"] = "Defiled Earth",
["code"] = "use(Wind Buffet:1963) [ enemy(#1).active ]\nuse(Alpha Strike:504) [ enemy.round=1 ]\nif [ enemy.hp<463 ]\n    change(#2) [ enemy(#2).dead ]\n    change(#2) [ enemy(#3).dead ]\nendif\nif [ self(#1).active & self.ability(#3).duration>1 ]\n    if [ self.ability(#1).strong & enemy.hp<=586 ]\n        use(1991)\n        standby\n    endif\n    if [ enemy.hp<=390 ]\n        use(1991)\n        standby\n    endif\n    use(1991) [ self.hpp<50 ]\nendif\nuse(1991) [ enemy.aura(Flying:341).exists & self.speed.fast ]\nuse(1991) [ enemy.aura(Underground:340).exists & self.speed.fast ]\nuse(1991) [ enemy.aura(Underwater:830).exists & self.speed.fast ]\nuse(1991) [ enemy.aura(Dodge:311).exists ]\nuse(1991) [ enemy.aura(Silk Cocoon:505).exists ]\nif [ self(#2).active & enemy(#1).active ]\n    use(Reflective Shield)\n    use(Explode:282)\nendif\nuse(Murder the Innocent:2223)\nuse(1533)\nuse(Trample:377)\nuse(#1)\nstandby\nchange(next)",
},
["team:530"] = {
["name"] = "Thenia's Loyal Companions (Mech)",
["code"] = "change(#1) [ !self(#1).active ]\nchange(#2) [ enemy(#3).active & enemy.round=1 & self.aura(Mechanical:244).exists ]\nchange(#3) [ enemy(#1).hpp<90 & enemy.ability(Wind Buffet:1963).usable & !enemy.ability(Moth Dust:508).usable ]\nstandby [ enemy(#3).active & self.aura(Mechanical:244).exists & self.aura(Extra Plating:391).exists & !self.aura(Cannon Shot Ready:1861).exists & !enemy.aura(Rooted:248).exists ]\nuse(Extra Plating:392) [ enemy(#1).active & self.aura(Arcane Shot Ready:1866).exists & enemy.hpp>90 ]\nuse(Extra Plating:392) [ enemy(#2).active & self.speed.fast ]\nuse(Extra Plating:392) [ enemy(#3).active & enemy.hpp<20 & !enemy.aura(Rooted:248).exists & !self.aura(Cannon Shot Ready:1861).exists ]\nuse(Cannon Shot:1860) [ round<8 & self.aura(Arcane Shot Ready:1866).exists & !self.aura(Cannon Shot Ready:1861).exists & enemy(#1).active & enemy.hpp<90 ]\nuse(Arcane Shot:1867) [ !enemy(#3).active ]\nuse(Make it Rain:985)\nuse(#1)\nstandby\nchange(#3)",
},
["team:103"] = {
["name"] = "Airborne Defense Force (Critter)",
["code"] = "quit [ self(#2).dead & enemy(#1).hp>624 ]\nchange(#2) [ round=2 ]\nuse(Apocalypse:519)\nuse(Survival:283) [ enemy.aura(Apocalypse:682).duration<2 & self.hpp<60 ]\nuse(#1) [ self(#3).active & enemy(#1).active ]\nuse(Shell Shield:310) [ self.round=1 ]\nuse(Shell Shield:310) [ self(#3).active & enemy.round=1 & !self.aura(Shell Shield:309).exists ]\nuse(Dive:564) [ enemy(#1).active & enemy.hp>487 ]\nuse(Void Crash:2358) [ enemy.aura(Apocalypse:682).duration<6 ]\nuse(#1) [ !enemy(#2).dead ]\nstandby\nchange(next)",
},
["team:231"] = {
["name"] = "Do You Even Train? (Elemental)",
["code"] = "use(Bubble:934)\nuse(Barrel Toss:354)\nuse(Scorched Earth:172)\nuse(Conflagrate:179) [ enemy.is(Swole:3573) ]\nuse(Flame Breath:501)\nuse(Puppies of the Flame:1354) [ enemy.aura(Underwater:830).exists ]\nif [ !enemy.ability(Headbutt:376).usable & enemy.ability(Dive:564).usable ]\n    if [ weather(Scorched Earth:171) ]\n        use(Puppies of the Flame:1354) [ self(#2).power=305 & enemy.hp>380 ]\n        use(Puppies of the Flame:1354) [ self(#2).power=289 & enemy.hp>376 ]\n        use(Puppies of the Flame:1354) [ self(#2).power=276 & enemy.hp>374 ]\n        use(Puppies of the Flame:1354) [ self(#2).power=260 & enemy.hp>371 ]\n    endif\n    use(Puppies of the Flame:1354) [ enemy.hp>315 ]\nendif\nif [ enemy.is(Swole:3573) & !enemy.aura(Underwater:830).exists ]\n    use(Superbark:1357) [ weather(Scorched Earth:171) ]\n    use(Superbark:1357) [ enemy.hp>315 ]\nendif\nuse(Blazing Yip:1359)\nstandby [ self.aura(Stunned:927).exists ]\nchange(next)",
...
["code"] = "use(Curse of Doom:218) [ enemy(#3).active & enemy.hp>1800 ]\nuse(Fade:1084) [ round=1 ]\nuse(Fade:1084) [ enemy.aura(Rain Dance:1061).exists ]\nuse(Amplify Magic:488) [ self.aura(Undead:242).exists ]\nuse(Arcane Storm:589) [ enemy(#2).active ]\nuse(Arcane Storm:589) [ !weather(Arcane Winds:590) ]\nuse(Spiritfire Beam:1035) [ self.aura(Amplify Magic:487).exists & enemy.hp<383 ]\nuse(Spiritfire Beam:1035) [ enemy(#2).active & enemy.hp<192 ]\nuse(Soulrush:752) [ self.aura(Cyclone:189).exists ]\nuse(#1)\nchange(next)",
},
["team:111"] = {
["name"] = "Farmer Nishi",
...
["code"] = "ability(Wing Buffet:1756) [ round=2 ]\nability(Wild Magic:592) [ enemy(#2).active & enemy.round=1 ]\nability(Infected Claw:117) [ enemy(#3).active & enemy.ability(Stone Form:1466).duration~4,5 ]\nability(#1) [ self.round=1 & self(#3).active ]\nability(Black Claw:919) [ enemy(#3).active & enemy.round=1 ]\nability(Black Claw:919) [ self.round=2 & self(#3).active ]\nability(Flock:581) [ enemy(#3).active & enemy.aura(Shattered Defenses:542).duration<2 ]\nability(#1)\nchange(next)",
},
["team:487"] = {
["name"] = "Resilient Survivors (Elemental)",
["code"] = "standby [ self.aura(Blinding Poison:1048).exists ]\nability(Whirlpool:513)\nability(Flash Freeze:1955)\nability(Breath of Sorrow:1055) [ enemy(#1).active ]\nability(Surge of Power:593) [ enemy.hp<1238 ]\nability(Blood in the Water:423) [ enemy.aura(Bleeding:491).exists ]\nability(Devour:538) [ self.ability(Blood in the Water:423).duration=3 ]\nability(#1)\nstandby\nchange(next)",
},
["team:474"] = {
["name"] = "Eyegor's Special Friends (Undead)",
["code"] = "ability(Bash:348) [ round=1 ]\nability(Toxic Smoke:640)\nability(Curse of Doom:218) [ enemy(#3).active ]\nability(Sludge Belch:2291)\nability(Dead Man's Party:1093) [ self.round=1 ]\nability(#1)\nchange(next)",
},
["team:15"] = {
["name"] = "Vesharr",
...
["code"] = "use(Poison Fang:152) [ round=1 ]\nuse(Puncture Wound:1050)\nuse(Pheromones:1063)\nchange(#2) [ round=4 ]\nuse(Booby-Trapped Presents:1080)\nuse(Pounce:535) [ enemy(#1).active ]\nuse(Gift of Winter's Veil:586) [ enemy(#2).active & enemy.hp>344 ]\nchange(#3) [ enemy(#3).active ]\nuse(Pounce:535)\nuse(Diseased Bite:499) [ enemy.is(Rocko:2994) & enemy.hp<345 ]\nuse(Rabid Strike:666) [ !enemy.aura(807).exists ]\nuse(Bash:348) [ enemy.is(Rocko:2994) & !enemy.ability(Stone Form:1466).usable ]\nuse(Diseased Bite:499)\nchange(next) [ self.dead ]",
},
["team:461"] = {
...
["code"] = "use(Arcane Storm:589) [ !enemy(#2).active & enemy.round<4 ]\nuse(Arcane Storm:589) [ !weather(Arcane Winds:590) & enemy.ability(Toxic Fumes:2349).duration>1 ]\nuse(Tail Sweep:122) [ self(#2).active & enemy(#1).active ]\nuse(Mana Surge:489) [ weather(Arcane Winds:590) ]\nuse(Tail Sweep:122)\nif [ enemy(#3).active ]\n    use(Surge of Power:593) [ enemy.hp<1111 & !enemy.ability(Rain Dance:1062).usable ]\n    use(Surge of Power:593) [ enemy.hp<650 ]\n    use(Howl:362)\n    use(Surge of Power:593)\nendif\nuse(Arcane Explosion:299)\nstandby\nchange(next)",
},
["team:524"] = {
["name"] = "Thenia's Loyal Companions (Undead)",
["code"] = "ability(Fade:1084) [ round=1 ]\nability(Fade:1084) [ enemy.aura(Prowl:543).exists & enemy.aura(Rain Dance:1061).exists ]\nability(Spiritfire Beam:1035) [ enemy(#1).active ]\nability(Spiritfire Beam:1035) [ enemy(#2).active ]\nability(Soulrush:752)\nability(Toxic Smoke:640)\nability(#1)\nstandby\nchange(#1)\nchange(next)",
},
["team:52"] = {
["name"] = "Horu Cloudwatcher",
["code"] = "ability(Bubble:934) [round=1]\nability(Stampede:163) [!enemy.aura(Shattered Defenses:542).exists]\nability(Explode:282) [self.hp<1061 & enemy.round>1 & enemy(#3).active]\nability(Supercharge:208) [enemy(#3).active]\nability(#1)\nchange(next)",
...
["code"] = "use(Powerball:566) [ enemy(Trailblazer:2988).active & !enemy.aura(Speed Boost:544).exists ]\nstandby [ enemy.ability(Dust Cloud:2059).usable ]\nuse(Burrow:159)\nstandby [ enemy.aura(Dodge:2060).exists ]\nuse(Powerball:566) [ !self.aura(Speed Boost:831).exists & enemy(Stinkdust:2987).active ]\nuse(Supercharge:208) [ self.aura(Wind-Up:458).exists ]\nuse(Wind-Up:459)\nuse(Decoy:334)\nuse(Thunderbolt:779)\nuse(#1)\nchange(next)",
},
["team:489"] = {
["name"] = "Resilient Survivors (Aquatic)",
["code"] = "change(#3) [ self.aura(Blinding Poison:1048).exists ]\nuse(Shell Armor:1380)\nuse(Bubble:934) [ !self.aura(Shell Armor:1379).exists ]\nuse(Headbutt:376) [ enemy(#1).active & enemy.hp<397 ]\nuse(Headbutt:376) [ enemy(#3).active ]\nuse(Shell Shield:310) [ self.aura(Shell Shield:309).duration<2 & enemy(#2).active ]\nuse(Shell Shield:310) [ self.aura(Blinding Poison:1048).exists & self.speed.fast ]\nuse(Shell Shield:310) [ self.aura(Swarm of Flies:231).exists & enemy.ability(Blinding Poison:1049).usable & self.speed.slow ]\nuse(Healing Wave:123) [ self.aura(Blinding Poison:1048).exists ]\nstandby [ self.aura(Blinding Poison:1048).exists & self.aura(Shell Shield:309).duration=5 ]\nuse(#1)\nchange(next)",
},
["team:492"] = {
["name"] = "Uncomfortably Undercover (Dragon)",
["code"] = "use(Ancient Blessing:611) [ round>2 & !self.aura(Dragonkin:245).exists ]\nuse(Ancient Blessing:611) [ enemy(#2).active ]\nuse(Surge of Power:593) [ enemy(#3).active & enemy.hp<732 & !enemy.aura(Dodge:2060).exists ]\nuse(Arcane Explosion:299) [ !enemy(#2).dead ]\nuse(#1)\nchange(next)",
},
["team:493"] = {
["name"] = "Uncomfortably Undercover (Flyer)",
["code"] = "use(Schattenmimik:2253) [ enemy.aura(Untot:242).exists ]\nstandby [ enemy.aura(Untot:242).exists ]\nstandby [ enemy.ability(Staubwolke:2059).usable & self.speed.slow ]\nstandby [ enemy.aura(Ausweichen:2060).exists & self.speed.slow ]\nuse(Abheben:170) [ enemy.aura(Ausweichen:2060).exists & self.speed.fast ]\nif [ !enemy(#3).active ]\n    change(#2) [ enemy.aura(Geblendet:1014).exists & enemy.hpp > 50 ]\n    change(#3) [ enemy.aura(Geblendet:1014).exists & enemy.hpp <= 50 ]\nendif\nchange(#1) [ enemy(#1).active & enemy.ability(KNOCHENSTURM:649).duration = 1 ]\nuse(Schlaghagel:360)\nuse(Dunkelkralle:1233)\nuse(Blendpulver:1015) [ enemy.ability(KNOCHENSTURM:649).usable ]\nuse(Blendpulver:1015) [ !enemy.ability(Staubwolke:2059).usable & !enemy.aura(Geblendet:1014).exists ]\nuse(Glühendes Toxin:270) [ !enemy.aura(Glühendes Toxin:271).exists ]\nuse(Explodieren:282)\nchange(#1)",
},
["team:535"] = {
["name"] = "Micro Defense Force (Critter)",
["code"] = "if [ self(#1).active ]\n    use(Nature's Ward:574) [ round = 1 ]\n    use(Stampede:163) [ round = 2 ]\n    use(Headbutt:376) [ self(#1).aura(Nature's Ward:820).exists ]\n    use(Nature's Ward:574) [ self(#1).aura(Nature's Ward:820).duration = 1 ]\n    use(Stampede:163)\n    change(#2) [ self(#1).dead ]\nendif\nif [ self(#2).active ]\n    use(Nature's Ward:574) [ !self(#2).aura(Nature's Ward:820).exists ]\n    use(Headbutt:376) [ self(#2).aura(Nature's Ward:820).exists ]\n    use(Stampede:163)\nendif\nchange(#3) [ self(#2).dead ]\nuse(#1)",
},
["team:536"] = {
["name"] = "Micro Defense Force (Magic)",
["code"] = "ability(Burn:113) [ enemy(#2).active ]\nability(Extra Plating:1733)\nability(Heat Up:945)\nability(Corrosion:447) [ self.round=1 ]\nability(Corrosion:447) [ self.ability(Life Exchange:277).duration=5 ]\nability(Life Exchange:277) [ enemy(#3).active ]\nability(Rot:476) [ !enemy.aura(Rot:1418).exists ]\nability(#1)\nchange(next)",
},
["team:477"] = {
["name"] = "Eyegor's Special Friends (Elemental)",
["code"] = "ability(Bash:348) [ round=1 ]\nability(Bash:348) [ enemy(#3).active & !enemy.ability(Stone Form:1466).usable ]\nability(Call Lightning:204)\nability(Wild Winds:514)\nability(Call Darkness:256)\nability(Agony:468) [ self.ability(Call Darkness:256).duration=5 ]\nability(Seethe:1056)\nchange(next)",
},
["team:465"] = {
["name"] = "The Mind Games of Addius (Critter)",
["code"] = "use(Acidic Goo:369) [ !enemy.aura(Acidic Goo:368).exists ]\nuse(Mind Games: Stun:2389)\nuse(Slime:1763)\nuse(Dive:564)\nuse(Poison Fang:152) [ !enemy.aura(Poisoned:379).exists ]\nuse(Stampede:163)\nuse(Predatory Strike:518)\nchange(next)",
},
["team:498"] = {
["name"] = "Uncomfortably Undercover (Beast)",
["code"] = "change(#2) [ round=7 ]\nuse(Blinding Poison:1049)\nuse(Puncture Wound:1050)\nuse(Vicious Fang:156)\nuse(Stoneskin:436) [ !self.aura(Stoneskin:435).exists ]\nuse(Thunderclap:1786)\nuse(Stampede:163)\nuse(Crouch:165)\nuse(Dazzling Dance:366) [ !self.aura(Dazzling Dance:365).exists ]\nuse(Flurry:360)\nchange(next)",
},
["team:558"] = {
["name"] = "Corrupted Thundertail",
["code"] = "ability(Blinding Powder:1015)\nability(Explode:282)\nability(Supercharge:208) [ enemy(#1).active ]\nability(Ion Cannon:209) [ enemy(#1).active ]\nability(Emerald Presence:597) [ self.aura(Emerald Presence:823).duration<2 ]\nability(Emerald Dream:598) [ self.hpp<66 ]\nability(Emerald Presence:597) [ enemy.aura(Dodge:311).exists ]\nability(Emerald Presence:597) [ enemy.aura(Flying:341).exists & self.speed.fast ]\nability(Emerald Presence:597) [ enemy.aura(Underground:340).exists & self.speed.fast ]\nability(Emerald Presence:597) [ enemy.aura(Silk Cocoon:505).exists ]\nability(Emerald Presence:597) [ enemy.aura(Underwater:830).exists & self.speed.fast ]\nability(#1)\nchange(next)",
},
["team:499"] = {
["name"] = "Uncomfortably Undercover (Aquatic)",
["code"] = "ability(Healing Wave:123)\nability(Healing Stream:922)\nability(Swarm of Flies:232) [ !enemy.aura(Swarm of Flies:231).exists ]\nability(Tongue Lash:228)\nstandby [ enemy.aura(Speed Boost:544).exists ]\nstandby [ enemy.aura(Dodge:2060).exists ]\nability(Skitter:626) [ enemy(Trailblazer:2988).active ]\nability(Black Claw:919) [ !enemy.aura(Black Claw:918).exists ]\nability(Swarm:706)\nchange(next)",
},
["team:205"] = {
["name"] = "Klutz's Battle Monkey",
["code"] = "ability(Ironskin:1758) [ round>2 ]\nability(Predatory Strike:518) [ enemy.aura(Shattered Defenses:542).exists & enemy.hpp>25 ]\nability(#1)\nchange(#2)",
...
["code"] = "use(Arcane Storm:589)\nuse(Mana Surge:489)\nuse(Call Lightning:204) [ enemy(#3).active ]\nuse(Thunderbolt:779) [ enemy(#2).hp<278 & !enemy(#3).active & !enemy(#2).ability(Rain Dance:1062).usable ]\nuse(Emerald Presence:597) [ self.aura(Emerald Presence:823).duration<2 ]\nuse(Emerald Dream:598) [ self.hpp<40 ]\nuse(#1)\nchange(#3) [ self.dead & enemy(#2).hp<309 ]\nchange(#2) [ self.dead ]\nchange(#1) [ self.dead ]\nstandby",
},
["team:104"] = {
["name"] = "Tiny Poacher, Tiny Animals",
["code"] = "-- rng in the beginning (<0.5%)\nquit [enemy(#1).dead & round=4]\n--\n-- rare case: too many critical strikes Ice lance Turn4+ 5\nuse(Explode:282) [enemy(#1).dead & enemy(#2).dead]\n--\nuse(Explode:282) [enemy(#1).dead & enemy(#3).dead & enemy(#2).hp<561]\nuse(Ice Tomb:624)\nuse(Call Blizzard:206)\nuse(Ice Lance:413)\nuse(Thunderbolt:779) [enemy(#3).active & enemy.aura(Stunned:927).exists]\nuse(Breath:115)\nchange(next)",
...
["team:564"] = {
["name"] = "Direflame",
["code"] = "change(#2) [ round=2 ]\nuse(Howl:362) [ round=3 ]\nuse(Surge of Power:593) [ round=4 ]\nuse(Elementium Bolt:606)\nuse(Bite:110)\nuse(Feedback:484)\nuse(Emerald Dream:598) [ self.hpp<70 ]\nuse(Emerald Presence:597) [ self.aura(823).duration<=1 ]\nuse(Emerald Presence:597) [ self.speed.fast & enemy.aura(341).exists ]\nuse(Emerald Presence:597) [ self.speed.fast & enemy.aura(340).exists ]\nuse(Emerald Presence:597) [ self.speed.fast & enemy.aura(830).exists ]\nuse(Emerald Presence:597) [ enemy.aura(311).exists ]\nuse(Emerald Presence:597) [ enemy.aura(505).exists ]\nuse(Emerald Bite:525)\nstandby\nchange(#1)\n-- This script was generated with wow-petsim.com",
},
["team:546"] = {
...
["code"] = "standby [ self.aura(Ice Barrier:480).exists ]\nuse(Ice Barrier:479) [ enemy(#3).active & enemy.aura(Unstable Engineering:2235).exists & enemy.hp<600 ]\nuse(Tough n' Cuddly:1112)\nuse(Call Blizzard:206) [ self(#1).active & enemy(#1).active ]\nuse(Call Blizzard:206) [ self(#2).active & enemy(#1).dead ]\nuse(Ice Barrier:479) [ enemy.aura(Prowl:543).exists ]\nuse(#1)\nchange(next)",
},
["team:278"] = {
["name"] = "Nicki Tinytech",
["code"] = "change(#3) [ !self(#3).played ]\nchange(#2) [ !self(#2).played ]\nchange(#2) [ self(#1).dead ]\nchange(#1)\nuse(Ancient Blessing:611) [ self.hpp < 70 & !self.aura(Dragonkin:245).exists ]\nuse(Ancient Blessing:611) [ self.hpp < 50 ]\nuse(Moonfire:595) [ weather(Moonlight:596).duration <= 1 ]\nuse(#1)\nstandby",
...
["code"] = "ability(Prowl:536) [ round=1 ]\nquit [ round=2 & self.aura(Asleep:498).exists ]\nability(Moonfire:595)\nability(Call Darkness:256)\nability(Prowl:536) [ enemy(Brite:3005).active ]\nability(Arcane Dash:1536)\nability(#1)\nchange(next)",
},
["team:483"] = {
["name"] = "Resilient Survivors (Flyer)",
["code"] = "ability(Black Claw:919) [ round=1 ]\nability(Flock:581)\nability(Moonfire:595) [ self.round=1 ]\nability(Moonfire:595) [ enemy.round=1 ]\nability(Soulrush:752) [ enemy.hp<805 & enemy(#2).active ]\nability(Feed:1016) [ self.hpp<100 ]\nability(Rend:441)\nability(#1)\nchange(next)",
},
["team:148"] = {
["name"] = "Deviate Smallclaw",
["code"] = "ability(Supercharge:208) [enemy.hpp>50]\nability(Laser:482) [enemy(Deviate Flapper:1987).active]\nability(Haywire:916)\nability(#1)\nchange(next)",
...
["team:447"] = {
["name"] = "Ziriak",
["code"] = "use(Uncanny Luck:252) [round=1]\nchange(#2) [round=2]\nuse(Time Bomb:602)\nuse(Armageddon:1025)\nuse(Void Nova:2356) [round=5]\nuse(Poison Protocol:1954) [round=6]\nuse(Corrosion:447)\nuse(#1)\nchange(#3)\n\n-- This script was generated with wow-petsim.com",
},
["team:557"] = {
["name"] = "Felfly",
