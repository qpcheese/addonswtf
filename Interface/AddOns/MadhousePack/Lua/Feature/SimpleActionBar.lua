...
local replacementTexture = Madhouse.API.v1.AddonFolder('Textures\\AltActionBar')
...
local function SetupSimpleActionBar()
...
Madhouse.feature.SimpleActionBar = {
    setup = SetupSimpleActionBar
}
