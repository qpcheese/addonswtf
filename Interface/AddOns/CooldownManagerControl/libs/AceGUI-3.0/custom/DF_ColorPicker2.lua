--[[-----------------------------------------------------------------------------
ColorPicker Widget with a Right Label
-------------------------------------------------------------------------------]]
local Type, Version = "DF_ColorPicker_Right_Label", 1
...
local function Constructor()
    ...
    colorSwatchButton:SetPoint("LEFT", frame, "LEFT", 0, 0)
    ...
    text:SetPoint("LEFT", colorSwatchButton, "RIGHT", 2, 0)
    text:SetPoint("RIGHT")
