...
function EL:ApplyHoverHUDVisibility(reason, forcedState)
    ...
    if ADT and ADT.DebugPrint then
        ADT.DebugPrint(string.format("[Housing] HoverHUD 可见性: enabled=%s, reason=%s", tostring(enabled), tostring(reason)))
    end
end
